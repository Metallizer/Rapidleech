...
$sites = array(
	...
	array('name' => 'Megaupload.com', 'link' => '^http://(www\.)?megaupload\.com/([a-z]{2}/)?\?d=\w{8}', 'regex' => '(class="download_l_descr")|(class="download_file_name")|(is password protected)', 'szregex' => 'class="download_file_size">\s([\d|\.]+)\s+(\w{1,5})', 'pattern' => '/\/([a-z]{2}\/)\?d=/i', 'replace' => '/?d='),
	...
	array('name' => 'FileSonic.com', 'link' => '^http://(www\.)?filesonic\.[^/]+/file/((([a-z]\d+/)?\d+)|(\w+))', 'regex' => 'class="downloadLink"', 'szregex' => 'class="fileSize">\(?([\d|\.]+)\s+(\w{1,5})\)?<'),
	...
	array('name' => 'ZShare.net', 'link' => '^http://(www\.)?zshare\.net/(download|audio|video)/\w+/?', 'regex' => '(File Size: )|(/delete\.html\?)', 'szregex' => '(?:(?:Video)|(?:File)) Size: <font color="#\w{6}">([\d|\.]+)\s*(\w{1,5})<', 'options' => array('fixsize' => true)),
	...
	array('name' => '4shared.com', 'link' => '^http://(www\.)?4shared\.com/[^/]+/\w+/.+\.html?', 'regex' => '(File name:)|(Please enter a password)', 'szregex' => 'title="Size:\s+([\d|\.|\,]+)\s+(\w{1,5})"', 'pattern' => '@4shared\.com/get/@i', 'replace' => '4shared.com/file/', 'options' => array('cookie' => '4langcookie=en', 'fixsize' => true, 'fixsizeP' => ',')),
	...
	array('name' => 'Mediafire.com', 'link' => '^http://(www\.)mediafire.com/(((download\.php)?\?)|(file/))(\w+)', 'regex' => '(class="download_file_title")', 'szregex' => 'Download <span>\(([\d|\.]+)\s+(\w{1,5})\)<'),
